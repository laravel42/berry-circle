...
--
-- agents.openfang_agent_id comes back nullable rather than NOT NULL. Existing
...
ALTER TABLE issues ADD COLUMN IF NOT EXISTS openfang_run_id text;
ALTER TABLE agents ADD COLUMN IF NOT EXISTS openfang_agent_id uuid;
ALTER TABLE model_role_agents ADD COLUMN IF NOT EXISTS openfang_agent_id text;
