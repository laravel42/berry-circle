...
DELETE FROM model_role_agents WHERE openfang_agent_id IS NULL;

DROP INDEX IF EXISTS model_role_agents_openfang_agent_id_key;

ALTER TABLE model_role_agents
    ALTER COLUMN openfang_agent_id SET NOT NULL;

ALTER TABLE model_role_agents
    ADD CONSTRAINT model_role_agents_openfang_agent_id_key UNIQUE (openfang_agent_id);
