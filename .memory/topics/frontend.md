...
- 2026-08-22 — Runs page dispatches `POST /api/v1/issues/{id}/runs` and follows `GET /api/v1/runs/{id}/events`. Agents hydrate from `GET /api/v1/agents`. Prototype OpenFang agent is `berry-prototype`.
