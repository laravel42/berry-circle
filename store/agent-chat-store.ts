...
import { chatTitleFrom, getAgentReply } from '@/lib/domain/agent';
...
/**
 * Fully client-side agent chat: conversations live in memory, replies
 * come from stub functions and are streamed word by word by the page component.
 * Will be replaced by API-driven streaming in M3.
 */
